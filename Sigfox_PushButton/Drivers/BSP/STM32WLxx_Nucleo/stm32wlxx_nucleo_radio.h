...
#define RF_SW_CTRL1_PIN                          GPIO_PIN_12 //4 pour ST, 12 pour LSM
#define RF_SW_CTRL1_GPIO_PORT                    GPIOB //C pour ST, B pour LSM
#define RF_SW_CTRL1_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE() //C pour ST, B pour LSM
#define RF_SW_RX_GPIO_CLK_DISABLE()              __HAL_RCC_GPIOB_CLK_DISABLE() //C pour ST, B pour LSM

#define RF_SW_CTRL2_PIN                          GPIO_PIN_13 //5 pour ST, 13 pour LSM
